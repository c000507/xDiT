...
def parse_args():
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Optional path to a standalone VAE checkpoint. Defaults to the base model's VAE "
            "subfolder."
        ),
    )
    parser.add_argument(
        ...
        default=None,
        help=(
            "Optional path to a standalone text encoder checkpoint. Defaults to the base model's "
